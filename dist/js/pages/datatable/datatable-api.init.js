...
$('.text-inputs-searching tfoot th').each(function () {
    var title = $(this).text();
    $(this).html('<input type="text" placeholder="Buscar ' + title + '" class="txtBusqueda" />');
});
...
$( document ).ready(function() {
    tableSearching = $('.text-inputs-searching').DataTable({
        "language": {
            "lengthMenu": "Mostrar _MENU_ Registros por pagina",
            "zeroRecords": "Registro no encontrado - valide los filtros por favor",
            "info": "Mostrando pagina _PAGE_ de _PAGES_ , Total Registros _TOTAL_ ",
            "infoEmpty": "No hay registros actualmente",
            ...
            initComplete: function () {
                ...
                this.api().columns().every(function () {
                    ...
                    $('input', this.header()).on('keyup change clear', function () {
                        if (that.search() !== this.value && this.type != "checkbox") {
                            that
                                .search(this.value)
                                .draw();
                        }
